...
Examples of system account can be found [here](https://github.com/centrify/terraform-provider-centrify/tree/main/examples/centrify_system)

Examples of database account can be found [here](https://github.com/centrify/terraform-provider-centrify/tree/main/examples/centrify_database)

Examples of domain account can be found [here](https://github.com/centrify/terraform-provider-centrify/tree/main/examples/centrify_domain)

Examples of cloud provider account can be found [here](https://github.com/centrify/terraform-provider-centrify/tree/main/examples/centrify_cloudprovider)
