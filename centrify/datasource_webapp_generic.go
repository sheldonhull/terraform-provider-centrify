...
func dataSourceGenericWebApp_deprecated() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceGenericWebAppRead,

		Schema:             getDSGenericWebAppSchema(),
		DeprecationMessage: "dataresource centrifyvault_webapp_generic is deprecated will be removed in the future, use centrify_webapp_generic instead",
	}
}
...
func getDSGenericWebAppSchema() map[string]*schema.Schema {
