...
func dataSourceSamlWebApp_deprecated() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceSamlWebAppRead,

		Schema:             getDSSamlWebAppSchema(),
		DeprecationMessage: "dataresource centrifyvault_webapp_saml is deprecated will be removed in the future, use centrify_webapp_saml instead",
	}
}
...
func getDSSamlWebAppSchema() map[string]*schema.Schema {
