...
func dataSourceDatabase_deprecated() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceDatabaseRead,

		Schema:             getDSDatabaseSchema(),
		DeprecationMessage: "dataresource centrifyvault_vaultdatabase is deprecated will be removed in the future, use centrify_database instead",
	}
}
...
func getDSDatabaseSchema() map[string]*schema.Schema {
