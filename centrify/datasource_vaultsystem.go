...
func dataSourceSystem_deprecated() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceSystemRead,

		Schema:             getDSSystemSchema(),
		DeprecationMessage: "dataresource centrifyvault_vaultsystem is deprecated will be removed in the future, use centrify_system instead",
	}
}
...
func getDSSystemSchema() map[string]*schema.Schema {
...
func dataSourceSystemRead(d *schema.ResourceData, m interface{}) error {
